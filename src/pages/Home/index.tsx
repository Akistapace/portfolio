...
const Section = ({ id, eyebrow, title, subtitle, children, container = true }: SectionProps) => (
	<section id={id} className='relative w-full'>
		<div className='container mx-auto px-4'>
			<div className='h-px w-full bg-gradient-to-r from-transparent via-neutral-400/40 to-transparent dark:via-white/20' />
		</div>
		<div
			className={`${container ? 'container mx-auto px-4' : ''} flex flex-col items-center pt-20 md:pt-28 pb-14 md:pb-24`}
		>
			<span className='mb-4 text-[11px] uppercase tracking-[0.4em] text-neutral-500 dark:text-neutral-400'>
				{eyebrow}
			</span>
			<h2 className='title text-center text-neutral-900 dark:text-white'>{title}</h2>
			<p className='mt-4 mb-16 max-w-2xl px-4 text-center text-neutral-600 dark:text-neutral-300'>{subtitle}</p>
			{children}
		</div>
	</section>
)
	...
	return (
		<div className='mx-auto w-full relative flex flex-col items-center justify-center overflow-hidden'>
			...
			<div className='relative z-10 w-full flex flex-col items-center'>
				...
				<Section id='about' eyebrow={t('header.about')} title={t('home.about.title')} subtitle={t('home.about.subtitle')}>
					<About />
				</Section>

				<Section
					id='experience'
					eyebrow={t('header.experience')}
				...
				<Section
					id='stacks'
					eyebrow={t('header.stacks')}
					title={t('home.stacks.title')}
					subtitle={t('home.stacks.subtitle')}
					container={false}
				>
					<SliderStacks />
				...
				<section className='relative w-full overflow-hidden' id='contact'>
					...
					<div className='flex flex-col items-center justify-center overflow-hidden'>
						<div className='container mx-auto pt-20 md:pt-28 flex flex-col items-center justify-center px-4'>
							<span className='mb-4 text-[11px] uppercase tracking-[0.4em] text-neutral-500 dark:text-neutral-400'>
								{t('header.contact')}
							</span>
							<h2 className='title text-center text-neutral-900 dark:text-white' title='contact'>
								{t('home.contact.title')}
							</h2>
							<p className='mt-4 max-w-2xl text-center text-neutral-600 dark:text-neutral-300'>
							...
							<div className='flex gap-4 mt-10'>
								<a
									...
									target='_blank'
									rel='noreferrer'
									className='invert dark:invert-0 transition-transform hover:scale-110'
								>
								...
								<a
									href='https://github.com/Akistapace'
									target='_blank'
									rel='noreferrer'
									className='invert dark:invert-0 transition-transform hover:scale-110'
								>
