...
export const Header = () => {
	...
	return (
		<>
			<header className='items-center flex justify-between w-full fixed top-0 z-50 h-16 bg-white/60 dark:bg-black/40 backdrop-blur-md border-b border-black/5 dark:border-white/10'>
				<div className='hidden md:flex  items-center container mx-auto py-2 px-4 justify-between w-full h-full'>
				...
				<div className='flex md:hidden items-center justify-end gap-2 px-4 w-full'>
					<LanguageSwitcher />
				</div>
