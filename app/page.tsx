	...
	return (
		<div className={styles.page} >
			<main className={styles.main} id="luxy">
				...
				<div className="container-full">
					<Section style={{ padding: "150px 0 20px 0" }}>
						<Title>Stacks</Title>
				...
				<div className={`container-full ${styles.projects}`}>
				...
				<div className="container-full">
					<Section>
						<div className="container" style={{ paddingTop: '100px', display: 'flex', flexDirection: 'column', alignItems: "center", justifyContent: 'space-between' }}>
							...
							<div className={styles.contactIcons}>
								<a href="https://br.linkedin.com/in/fernando-aquistaoace-33a414165/pt" target="_blank">
