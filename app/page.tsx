...
import BackgroundStars from './components/BackgroundStars/Section'
	...
	return (
		<div className={styles.page}>
			<main className={styles.main} id='luxy'>
				<section className='container-full' style={{ height: '100vh' }}>
					<StarField />
				</section>
						...
						<div>
							...
							>
								...
								<div className={styles.contactIcons}>
									...
									<a href='https://github.com/Akistapace' target='_blank' rel='noreferrer'>
										<svg xmlns='http://www.w3.org/2000/svg' width='48' height='48' viewBox='0 0 48 48' fill='none'>
											<title>LinkedIn Icon</title>
