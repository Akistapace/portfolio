          ...
          <div className={styles.profile}>
            ...
            <div className={styles.body}>
              <div className={styles.text}>
                ...
                <p>Feel free to connect with me via LinkedIn, GitHub, or email.</p>
              </div>
            </div>
            <div className={styles.footer}>
              ...
              <a href="https://github.com/Akistapace" target="_blank" rel="noopener noreferrer">
              ...
              <a href="mailto:fernando.akistapace@gmail.com" target="_blank" rel="noopener noreferrer">
